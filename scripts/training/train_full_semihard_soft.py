...
if __name__ == "__main__":
    ...
    head = train(
        ...
        log_interval=10,
        device=device,
        log_dir="runs/full_semihard_soft",
        checkpoint_path="checkpoints/full_semihard_soft_head.pt",
    )
    ...
    print("soft-margin + batch-hard (reference): 0.5584")
    print("hard-margin + semi-hard (reference): 0.6618")
